...
function createCalender(obj) {
    ...
    calenderBigBG.src = "img/calenderBigBG.png";
    modalBG.src = "img/modalBG.png";
    searchSubmit.src = "img/searchSubmit.png";
    searchText.src = "img/searchText.png";
    obj.innerHTML = iHTML
}
...
function fillCalender(obj, tMonth, tYear, highlight) {
    ...
    var calenderObj = obj.parentNode.parentNode;
    if (c > 35) {
        calenderObj.style.background = "url('img/calenderBigBG.png')";
        calenderObj.style.height = "462px"
    } else {
        calenderObj.style.background = "url('img/calenderBG.png')";
